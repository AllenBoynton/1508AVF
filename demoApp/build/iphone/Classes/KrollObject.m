...
//@interface demoAppObject : NSObject
//@end

@interface demoAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[demoAppObject class]])
		{
			for (NSString *key in [[(demoAppObject*)o modules] allKeys])
			{
