...
//Rare exceptions to indicate a bug in the _week3project code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Week3Project proxies.
 */
