...
// in simulator we redefine to format for Week3Project Developer console
...
{\
	NSString * exceptionName = [@"org.week3project." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.week3project";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIWeek3ProjectNativeItemNone = -1, 
	UIWeek3ProjectNativeItemSpinner = -2,
	UIWeek3ProjectNativeItemProgressBar = -3,
	
	UIWeek3ProjectNativeItemSlider = -4,
	UIWeek3ProjectNativeItemSwitch = -5,
	UIWeek3ProjectNativeItemMultiButton = -6,
	UIWeek3ProjectNativeItemSegmented = -7,
	
	UIWeek3ProjectNativeItemTextView = -8,
	UIWeek3ProjectNativeItemTextField = -9,
	UIWeek3ProjectNativeItemSearchBar = -10,
	
	UIWeek3ProjectNativeItemPicker = -11,
	UIWeek3ProjectNativeItemDatePicker = -12,
	
	UIWeek3ProjectNativeItemInfoLight = -13,
	UIWeek3ProjectNativeItemInfoDark = -14,
	
	UIWeek3ProjectNativeItemDisclosure = -15,
	
	UIWeek3ProjectNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Week3Project instances of
