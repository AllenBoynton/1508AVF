...
//@interface Week3ProjectObject : NSObject
//@end

@interface Week3ProjectObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Week3ProjectObject class]])
		{
			for (NSString *key in [[(Week3ProjectObject*)o modules] allKeys])
			{
