...
/**
 Base class for all Week3Project views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Week3Project view hierarchy (such as wrapped iOS UIViews) was touched.
