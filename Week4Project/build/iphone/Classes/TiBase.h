...
// in simulator we redefine to format for Week4Project Developer console
...
{\
	NSString * exceptionName = [@"org.week4project." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.week4project";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIWeek4ProjectNativeItemNone = -1, 
	UIWeek4ProjectNativeItemSpinner = -2,
	UIWeek4ProjectNativeItemProgressBar = -3,
	
	UIWeek4ProjectNativeItemSlider = -4,
	UIWeek4ProjectNativeItemSwitch = -5,
	UIWeek4ProjectNativeItemMultiButton = -6,
	UIWeek4ProjectNativeItemSegmented = -7,
	
	UIWeek4ProjectNativeItemTextView = -8,
	UIWeek4ProjectNativeItemTextField = -9,
	UIWeek4ProjectNativeItemSearchBar = -10,
	
	UIWeek4ProjectNativeItemPicker = -11,
	UIWeek4ProjectNativeItemDatePicker = -12,
	
	UIWeek4ProjectNativeItemInfoLight = -13,
	UIWeek4ProjectNativeItemInfoDark = -14,
	
	UIWeek4ProjectNativeItemDisclosure = -15,
	
	UIWeek4ProjectNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Week4Project instances of
