...
@interface Week4ProjectObject : KrollCoverageObject {
#else
@interface Week4ProjectObject : KrollObject {
#endif
@private
...
extern NSString * Week4Project$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Week4ProjectObject *_week4project;
    KrollObject* console;
	BOOL shutdown;
