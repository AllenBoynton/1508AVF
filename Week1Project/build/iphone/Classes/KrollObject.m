...
//@interface Week1ProjectObject : NSObject
//@end

@interface Week1ProjectObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Week1ProjectObject class]])
		{
			for (NSString *key in [[(Week1ProjectObject*)o modules] allKeys])
			{
