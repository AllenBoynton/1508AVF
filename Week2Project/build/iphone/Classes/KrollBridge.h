...
@interface Week2ProjectObject : KrollCoverageObject {
#else
@interface Week2ProjectObject : KrollObject {
#endif
@private
...
extern NSString * Week2Project$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Week2ProjectObject *_week2project;
    KrollObject* console;
	BOOL shutdown;
