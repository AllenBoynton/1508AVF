...
/**
 Base class for all Week2Project views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Week2Project view hierarchy (such as wrapped iOS UIViews) was touched.
