...
// in simulator we redefine to format for Week1Project Developer console
...
{\
	NSString * exceptionName = [@"org.week1project." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.week1project";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIWeek1ProjectNativeItemNone = -1, 
	UIWeek1ProjectNativeItemSpinner = -2,
	UIWeek1ProjectNativeItemProgressBar = -3,
	
	UIWeek1ProjectNativeItemSlider = -4,
	UIWeek1ProjectNativeItemSwitch = -5,
	UIWeek1ProjectNativeItemMultiButton = -6,
	UIWeek1ProjectNativeItemSegmented = -7,
	
	UIWeek1ProjectNativeItemTextView = -8,
	UIWeek1ProjectNativeItemTextField = -9,
	UIWeek1ProjectNativeItemSearchBar = -10,
	
	UIWeek1ProjectNativeItemPicker = -11,
	UIWeek1ProjectNativeItemDatePicker = -12,
	
	UIWeek1ProjectNativeItemInfoLight = -13,
	UIWeek1ProjectNativeItemInfoDark = -14,
	
	UIWeek1ProjectNativeItemDisclosure = -15,
	
	UIWeek1ProjectNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Week1Project instances of
