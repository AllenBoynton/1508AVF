...
/**
 Base class for all Week4Project views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Week4Project view hierarchy (such as wrapped iOS UIViews) was touched.
