...
// in simulator we redefine to format for Week2Project Developer console
...
{\
	NSString * exceptionName = [@"org.week2project." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.week2project";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIWeek2ProjectNativeItemNone = -1, 
	UIWeek2ProjectNativeItemSpinner = -2,
	UIWeek2ProjectNativeItemProgressBar = -3,
	
	UIWeek2ProjectNativeItemSlider = -4,
	UIWeek2ProjectNativeItemSwitch = -5,
	UIWeek2ProjectNativeItemMultiButton = -6,
	UIWeek2ProjectNativeItemSegmented = -7,
	
	UIWeek2ProjectNativeItemTextView = -8,
	UIWeek2ProjectNativeItemTextField = -9,
	UIWeek2ProjectNativeItemSearchBar = -10,
	
	UIWeek2ProjectNativeItemPicker = -11,
	UIWeek2ProjectNativeItemDatePicker = -12,
	
	UIWeek2ProjectNativeItemInfoLight = -13,
	UIWeek2ProjectNativeItemInfoDark = -14,
	
	UIWeek2ProjectNativeItemDisclosure = -15,
	
	UIWeek2ProjectNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Week2Project instances of
