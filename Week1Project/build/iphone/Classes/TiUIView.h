...
/**
 Base class for all Week1Project views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Week1Project view hierarchy (such as wrapped iOS UIViews) was touched.
