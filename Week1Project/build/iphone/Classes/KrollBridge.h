...
@interface Week1ProjectObject : KrollCoverageObject {
#else
@interface Week1ProjectObject : KrollObject {
#endif
@private
...
extern NSString * Week1Project$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Week1ProjectObject *_week1project;
    KrollObject* console;
	BOOL shutdown;
