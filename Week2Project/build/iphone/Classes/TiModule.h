...
/**
 The base class for all Week2Project modules
 */
...
/**
 Week2Project Platform calls this method on startup.
 */
-(void)startup;

/**
 Week2Project Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Week2Project Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Week2Project Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Week2Project Platform calls this method on resume.
 @param sender The sender of the event.
 */
