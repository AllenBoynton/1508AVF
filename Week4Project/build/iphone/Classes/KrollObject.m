...
//@interface Week4ProjectObject : NSObject
//@end

@interface Week4ProjectObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Week4ProjectObject class]])
		{
			for (NSString *key in [[(Week4ProjectObject*)o modules] allKeys])
			{
