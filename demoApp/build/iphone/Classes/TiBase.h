...
// in simulator we redefine to format for demoApp Developer console
...
{\
	NSString * exceptionName = [@"org.demoapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.demoapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIdemoAppNativeItemNone = -1, 
	UIdemoAppNativeItemSpinner = -2,
	UIdemoAppNativeItemProgressBar = -3,
	
	UIdemoAppNativeItemSlider = -4,
	UIdemoAppNativeItemSwitch = -5,
	UIdemoAppNativeItemMultiButton = -6,
	UIdemoAppNativeItemSegmented = -7,
	
	UIdemoAppNativeItemTextView = -8,
	UIdemoAppNativeItemTextField = -9,
	UIdemoAppNativeItemSearchBar = -10,
	
	UIdemoAppNativeItemPicker = -11,
	UIdemoAppNativeItemDatePicker = -12,
	
	UIdemoAppNativeItemInfoLight = -13,
	UIdemoAppNativeItemInfoDark = -14,
	
	UIdemoAppNativeItemDisclosure = -15,
	
	UIdemoAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all demoApp instances of
