...
@interface Week3ProjectObject : KrollCoverageObject {
#else
@interface Week3ProjectObject : KrollObject {
#endif
@private
...
extern NSString * Week3Project$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Week3ProjectObject *_week3project;
    KrollObject* console;
	BOOL shutdown;
